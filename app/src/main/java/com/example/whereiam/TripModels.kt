...
enum class ActivityProfile(
    ...
    HIKING("Hiking", "🥾", 2.5f, 15_000L, 1.0f, 10, 60_000L, 30_000L),
    RUNNING("Running", "🏃", 5.0f, 10_000L, 2.5f, 5, 20_000L, 10_000L),
    WALKING("Walking", "🚶", 2.5f, 15_000L, 1.5f, 10, 60_000L, 30_000L)
}
